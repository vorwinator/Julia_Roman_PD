    ...
    <div class="col-md-8 col-lg-6 col-xl-4 offset-1">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-floating mb-3">
                    <?php
                    echo form_input('working_hours_open_monday', set_value('working_hours_open_monday'), 'class="form-control form-control-lg" placeholder="Otwarcie"');
            ...
            <div class="col-md-3">
                <div class="form-floating mb-3">
                    <?php
                    echo form_input('working_hours_close_monday', set_value('working_hours_close_monday'), 'class="form-control form-control-lg" placeholder="Zamknięcie"');
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-floating mb-3">
                    <?php
                    echo form_input('working_hours_open_tuesday', set_value('working_hours_open_tuesday'), 'class="form-control form-control-lg" placeholder="Otwarcie"');
            ...
            <div class="col-md-3">
                <div class="form-floating mb-3">
                    <?php
                    echo form_input('working_hours_close_tuesday', set_value('working_hours_close_tuesday'), 'class="form-control form-control-lg" placeholder="Zamknięcie"');
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-floating mb-3">
                    <?php
                    echo form_input('working_hours_open_wednesday', set_value('working_hours_open_wednesday'), 'class="form-control form-control-lg" placeholder="Otwarcie"');
            ...
            <div class="col-md-3">
                <div class="form-floating mb-3">
                    <?php
                    echo form_input('working_hours_close_wednesday', set_value('working_hours_close_wednesday'), 'class="form-control form-control-lg" placeholder="Zamknięcie"');
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-floating mb-3">
                    <?php
                    echo form_input('working_hours_open_thursday', set_value('working_hours_open_thursday'), 'class="form-control form-control-lg" placeholder="Otwarcie"');
            ...
            <div class="col-md-3">
                <div class="form-floating mb-3">
                    <?php
                    echo form_input('working_hours_close_thursday', set_value('working_hours_close_thursday'), 'class="form-control form-control-lg" placeholder="Zamknięcie"');
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-floating mb-3">
                    <?php
                    echo form_input('working_hours_open_friday', set_value('working_hours_open_friday'), 'class="form-control form-control-lg" placeholder="Otwarcie"');
            ...
            <div class="col-md-3">
                <div class="form-floating mb-3">
                    <?php
                    echo form_input('working_hours_close_friday', set_value('working_hours_close_friday'), 'class="form-control form-control-lg" placeholder="Zamknięcie"');
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-floating mb-3">
                    <?php
                    echo form_input('working_hours_open_saturday', set_value('working_hours_open_saturday'), 'class="form-control form-control-lg" placeholder="Otwarcie"');
            ...
            <div class="col-md-3">
                <div class="form-floating mb-3">
                    <?php
                    echo form_input('working_hours_close_saturday', set_value('working_hours_close_saturday'), 'class="form-control form-control-lg" placeholder="Zamknięcie"');
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-floating mb-3">
                    <?php
                    echo form_input('working_hours_open_sunday', set_value('working_hours_open_sunday'), 'class="form-control form-control-lg" placeholder="Otwarcie"');
            ...
            <div class="col-md-3">
                <div class="form-floating mb-3">
                    <?php
                    echo form_input('working_hours_close_sunday', set_value('working_hours_close_sunday'), 'class="form-control form-control-lg" placeholder="Zamknięcie"');
